...
# optimizer : rmsprop,adam
	...
	#on peut récupérer le vecteur de poids pour repartir la ou l'entrainement s'est arrété
	#model.load_weights('weigths_tests/weights_sequence50_500_loss1-97_Adam.hdf5')
	return model
